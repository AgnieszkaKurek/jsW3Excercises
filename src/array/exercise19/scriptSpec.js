...
describe("Compute the sum of each individual index value from the given arrays: ", (() => {
    ...
    it("if we add two one element arrays, the result will be one element array", () => {
        let sumOfEachElemValue = computSumOfEachIndividualElemValue([2], [2]);
        expect(sumOfEachElemValue).toEqual([4]);
    });
    it("if we add two elements array and five elements array, the result will be a five elements array", () => {
        let sumOfEachElemValue = computSumOfEachIndividualElemValue([1, 14], [1, 8, 9, 12, 15]);
        expect(sumOfEachElemValue).toEqual([2, 22, 9, 12, 15]);
    });
    it("if we add five elements array and six elements array, the result will be a six elements array", () => {
